...
##      problems using the linear regression approach.                      ##
...
# relevant = ['Gender','Age Range','Head Size']
# relevant = ['Head Size']
relevant = ['Math', 'Reading']

# This dictionary lists the normalization desired for each column
# normalization_dictionary = {\
#                               'Head Size': 'standardize',\
#                               'Label':     'standardize'\
#                            }
...
def main():
    ...
    # fig = plt.figure()
    # ax = Axes3D(fig)
    # ax.scatter(dataframe[relevant[0]], dataframe[relevant[1]], dataframe['Label'], color='purple', alpha=0.2)
